...
<body>
    ...
    <div class="main">
        <div class="texto-sobre">
            <h1>Sobre Nós</h1>
            <p>Bem-vindo ao SosaBank - Uma História de Confiança e Inovação

                No SosaBank, acreditamos que a confiança é a base de qualquer relacionamento financeiro sólido. Desde a nossa fundação, temos o compromisso de oferecer serviços financeiros de qualidade, apoiados por uma equipe dedicada e por valores fundamentais que orientam todas as nossas decisões.</p>
